...
?ELS8:	PUTP	JEWELLED-BOX,P?LDESC,STR?133
...
?ELS30:	FSET?	PRSI,WEAPONBIT \?ELS34
	ZERO?	ROPE-MAGIC? /?ELS39
	PRINTR	"The rope seems to be pretty strong stuff. You don't seem to be making the least progress in breaking it."
?ELS39:	PRINTR	"The rope cuts cleanly, and falls to pieces on the floor. It must have been pretty rotten."
?ELS34:	PRINTI	"You certainly won't get anywhere using the "
	PRINTD	PRSI
	PRINTR	"!"
?ELS25:	EQUAL?	PRSA,V?KULCAD \?ELS52
	SET	'ROPE-MAGIC?,0
...
?ELS52:	EQUAL?	PRSA,V?DROP \FALSE
	...
	PUTP	JEWELLED-BOX,P?LDESC,STR?136
	RTRUE	
