...
?ELS17:	GET	INDENTS,LEVEL
	PRINT	STACK
	PRINTI	"A"
	FSET?	OBJ,VOWELBIT \?CND35
	PRINTI	"n"
?CND35:	EQUAL?	OBJ,BREAD \?ELS42
	GETP	OBJ,P?SIZE
	LESS?	STACK,8 \?CND40
	PRINTI	" partially eaten"
	JUMP	?CND40
?ELS42:	EQUAL?	OBJ,WATER \?CND40
	GETP	OBJ,P?SIZE
	LESS?	STACK,2 \?CND50
	PRINTI	" very"
?CND50:	GETP	OBJ,P?SIZE
	LESS?	STACK,3 \?CND40
	PRINTI	" small"
?CND40:	PRINTI	" "
	PRINTD	OBJ
	FSET?	OBJ,WEARBIT \?ELS64
	PRINTI	" (being worn)"
	JUMP	?CND1
?ELS64:	FSET?	OBJ,LIGHTBIT \?CND1
	FSET?	OBJ,ONBIT \?CND1
	PRINTI	" (providing light)"
...
?PRD49:	PUSH	0
	RETURN	STACK
?ELS43:	EQUAL?	Y,AV,PROTAGONIST \?ELS52
	JUMP	?CND41
...
?ELS18:	PRINTI	"This puts you in the class of "
	...
	CRLF	
	CALL	V-SCORE
	PRINTI	"Would you like to start the game again? (Y is affirmative): "
	CALL	YES?
	ZERO?	STACK /?ELS7
	RESTART	
	RTRUE	
...
?ELS5:	PRINTR	"Ok."
	...
	PRINTI	"ENCHANTER: INTERLOGIC Fantasy
Copyright (C) 1983 by Infocom, Inc. All rights reserved.
ENCHANTER and INTERLOGIC are trademarks of Infocom, Inc.
Release "
	GET	0,1
	BAND	STACK,2047
	PRINTN	STACK
...
?CND8:	SET	'OBJ,STACK
	ZERO?	OBJ /?ELS23
	EQUAL?	OBJ,PSEUDO-OBJECT,ROOMS /?ELS23
...
?PRD2:	SET	'CHEATED?,STACK
	...
	JUMP	?PRD5
?ELS4:	SET	'OZMOOD?,0
?PRD5:	SET	'DEATH-CHEATED,0
	ZERO?	DESC /?CND6
	PRINT	DESC
	CRLF	
?CND6:	EQUAL?	PROTAGONIST,WINNER /?CND12
	PRINTI	"
*** The "
	PRINTD	WINNER
	PRINTI	" has died *** 
...
?ELS49:	CALL	OUTSIDE?,HERE
	...
	CRLF	
	RETURN	2
?ELS55:	PRINTI	"You can't go that way."
	CRLF	
	RETURN	2
?ELS36:	EQUAL?	PTS,DEXIT \FALSE
	GETB	PT,DEXITOBJ >OBJ
	FSET?	OBJ,OPENBIT \?ELS72
	GETB	PT,REXIT
	CALL	GOTO,STACK
	RSTACK	
...
?ELS74:	PRINTI	"The "
	...
	CALL	THIS-IS-IT,OBJ
	RETURN	2
?ELS12:	ZERO?	LIT \?ELS86
	RANDOM	100
	GRTR?	90,STACK \?ELS86
	CALL	JIGS-UP,STR?12
	RETURN	2
?ELS86:	EQUAL?	WINNER,TURTLE \?ELS92
	PRINTR	"""I can't go that way."""
?ELS92:	PRINTI	"You can't go that way."
	CRLF	
	RETURN	2
...
?CND11:	PRINTI	"The "
	...
	CRLF	
	RTRUE	
?ELS3:	FSET?	PRSO,ONBIT \?ELS23
	PRINTR	"It's not easy to see how. It's glowing by magic."
?ELS23:	PRINTR	"You can't turn that off."
...
?CND6:	EQUAL?	HERE,RM \TRUE
	EQUAL?	PROTAGONIST,WINNER /?ELS20
	EQUAL?	HERE,CLOSET,ENGINE-ROOM /?ELS23
	IN?	PROTAGONIST,OHERE \?ELS23
	PRINTI	"The "
	PRINTD	WINNER
