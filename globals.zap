...
?ELS31:	EQUAL?	PRSA,V?BLORB \?ELS35
	CALL	JIGS-UP,STR?49,0
	RTRUE	
?ELS35:	EQUAL?	PRSA,V?EXAMINE \?ELS37
	PRINTR	"You are not a pretty sight."
?ELS37:	EQUAL?	PRSA,V?GIVE \?ELS41
	PRINTR	"I think you're a little confused."
?ELS41:	EQUAL?	PRSA,V?ATTACK,V?MUNG,V?KILL \?ELS45
	PRINTR	"You don't need my help to do that!"
?ELS45:	EQUAL?	PRSA,V?FIND \?ELS49
	PRINTR	"You're right here!"
?ELS49:	EQUAL?	PRSA,V?ATTACK,V?MUNG,V?CUT \FALSE
...
?ELS91:	IN?	WATER,JUG \?THN96
	GETP	WATER,P?SIZE
	LESS?	STACK,4 \?ELS95
?THN96:	MOVE	WATER,JUG
	PUTP	WATER,P?SIZE,4
	PRINTI	"The jug is now full of "
	EQUAL?	HERE,BEACH \?ELS102
	FSET	WATER,RMUNGBIT
	PRINTI	"sea"
	JUMP	?CND100
?ELS102:	EQUAL?	HERE,FOREST-2 \?ELS106
	FSET	WATER,RMUNGBIT
	PRINTI	"foul algae-infested "
	JUMP	?CND100
?ELS106:	FCLEAR	WATER,RMUNGBIT
?CND100:	PRINTR	"water."
?ELS95:	CALL	GLOBAL-IN?,GLOBAL-WATER,HERE
	ZERO?	STACK /?ELS114
	PRINTR	"The jug is already full."
?ELS114:	PRINTR	"The only water here is in the jug."
?ELS86:	IN?	PRSO,JUG \?ELS122
	EQUAL?	PRSA,V?TAKE \?ELS122
	ZERO?	PRSI \?ELS122
	SET	'PRSO,JUG
	CALL	ITAKE
	SET	'PRSO,W
	RTRUE	
?ELS122:	PRINTR	"The water slips through your fingers."
?ELS60:	ZERO?	PI? /?ELS130
	PRINTR	"Nice try."
?ELS130:	EQUAL?	PRSA,V?GIVE,V?DROP \?ELS135
	REMOVE	WATER
	EQUAL?	PRSI,SEA,GLOBAL-WATER \?ELS140
	PRINTR	"Ok, but there was plenty enough there already."
?ELS140:	PRINTR	"The water spills to the ground and evaporates."
?ELS135:	EQUAL?	PRSA,V?POUR-ON \?ELS148
	REMOVE	WATER
	PRINTI	"The water cascades off the "
	PRINTD	PRSI
	PRINTR	" and onto the ground."
?ELS148:	EQUAL?	PRSA,V?THROW \FALSE
...
?CND12:	EQUAL?	WINNER,PROTAGONIST \?ELS33
