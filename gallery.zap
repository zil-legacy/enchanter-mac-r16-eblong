...
?ELS14:	IN?	ETERNAL-FLAME,PORTRAIT-NICHE \FALSE
	FSET?	ETERNAL-FLAME,ONBIT \FALSE
	MOVE	LIGHTED-PORTRAIT,HERE
	ZERO?	VISITED-GALLERY? /?ELS30
	PRINTI	"An eerie orange glow casts a pale, flickering light on the portrait gallery."
	JUMP	?CND28
?ELS30:	SET	'VISITED-GALLERY?,1
	PRINTI	"The east-west corridor opens into a portrait gallery. The gallery is lit by an eerie orange glow."
?CND28:	PRINTR	" The eyes of the figures portrayed on the canvases seem to be faintly illuminated and follow your every movement. After a moment, the source of light becomes clear: a single lighted portrait flickers as if a flame were burning behind it."
...
?ELS5:	EQUAL?	PRSA,V?EXAMINE \FALSE
	PRINTR	"The Wizard of Frobozz was a former member of the Circle of Enchanters, but he was removed for forgetfulness bordering on senility. The lively wit of his youth having been replaced by a semi-sadistic mischievousness coupled with an inability to pronounce words beginning with other than the letter ""F"", he was ""retired"" to a small, unoccupied corner of the Great Underground Empire, hopefully out of harm's way."
