...
?ELS68:	ZERO?	ADV-HASTE \?ELS73
	...
	CALL	I-ADVENTURER
	RTRUE	
?ELS73:	SET	'ADV-HASTE,0
	CALL	ADVENTURER-DECIDE,L
	RTRUE	


	.FUNCT	MOVE-ADVENTURER,RM,L,CNT=0,OBJ
	LOC	ADVENTURER >L
...
?ELS34:	EQUAL?	HERE,RM \?CND32
	EQUAL?	HERE,PURLOINED-ROOM \?ELS61
	FSET?	MAP-ROOM,VILLAIN /?ELS61
	...
	CRLF	
	JUMP	?CND32
?ELS61:	PRINTI	"A bedraggled adventurer "
	EQUAL?	HASTED?,ADVENTURER \?ELS72
	PRINTI	"speeds"
	JUMP	?CND70
?ELS72:	PRINTI	"walks"
?CND70:	PRINTI	" into the room from "
	CALL	DIR-FROM,RM,L
	CALL	DIR-PRINT,STACK
...
?CND32:	MOVE	ADVENTURER,RM
	...
	.FUNCT	DOOR-FROM?,HERE,THERE,P,L,T
	SET	'P,0
?PRG1:	NEXTP	HERE,P >P
	ZERO?	P /FALSE
...
?CND39:	PRINTR	"."
	...
	.FUNCT	DIR-FROM,HERE,THERE,P,L,T,O
	SET	'P,0
?PRG1:	NEXTP	HERE,P >P
	ZERO?	P /FALSE
	EQUAL?	P,P?IN \?ELS7
...
?CND3:	INC	'CNT
	...
	.FUNCT	ADVENTURER-DECIDE,L,P,S,T
	NEXTP	L,0 >P
	PUT	ADV-POSS,0,0
...
?PRG28:	IGRTR?	'P,S \?ELS32
	JUMP	?REP29
?ELS32:	GET	ADV-POSS,P >T
	FSET?	T,VILLAIN /?PRG28
	CALL	MOVE-ADVENTURER,T
	RTRUE	
...
?KLU11:	JUMP	?PRG1
	...
	.FUNCT	PURLOINED-ROOM-A,T
	CALL	TREASURE-HERE?,PURLOINED-ROOM >T
	ZERO?	T /?ELS3
	SET	'ADVENTURER-STAY,1
...
""I'm going on ahead!"" he cries and disappears through a simple wooden door.
Wooden door? You rub your eyes for a moment and look again. Yes, just a plain wooden door."
	CRLF	
