...
?CND1:	SET	'SPELL,STACK
	FSET?	SPELL,RMUNGBIT \?ELS44
	PRINTR	"The spell is defaced beyond recognition."
?ELS44:	LOC	SPELL >SCROLL
	FSET?	SCROLL,SCROLLBIT \?CND42
	IN?	SCROLL,WINNER \?ELS51
	REMOVE	SCROLL
	EQUAL?	PRSO,KRILL /?CND52
	PRINTI	"As you cast the spell, the "
	PRINTD	SCROLL
	PRINTI	" vanishes!"
	CRLF	
?CND52:	PUTP	SPELL,P?COUNT,1
	JUMP	?CND42
?ELS51:	FSET?	SPELL,TOUCHBIT /?THN59
	IN?	SCROLL,HERE \?ELS58
?THN59:	PRINTI	"You don't have the "
	PRINTD	SPELL
...
?THN6:	SET	'FLYING?,1
	...
	PRINTR	"Your descent slows, and you are floating serenely in mid-air. The tower surrounds you, with wide-cut openings to the east and west. You could probably fly in either direction if you wished."
