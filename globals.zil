...
<OBJECT PROTAGONIST		;"was ADVENTURER"
	(SYNONYM ENCHANTER)
	(DESC "cretin")
...
be desired." <>>
		...
		<TELL "You're right here!" CR>)
	       (<AND <VERB? CUT MUNG ATTACK> <==? ,PRSI ,MAGIC-KNIFE>>
		<TELL
...
"The jug has no cover. It can't be opened or closed." CR>
	 ...
	 <COND (<VERB? EXAMINE LOOK-INSIDE>
		<TELL "The jug is ">
	       ...
	       (<AND .E? <IN? ,WATER ,PRSO>>
		<TELL "The water spills to the ground and evaporatesl" CZ>
		<REMOVE ,WATER>
		T)>>
...
"The " D ,PRSI " isn't a very good container." CR>)>)
		...
		<COND (<EQUAL? ,PRSI ,SEA ,GLOBAL-WATER>
		       <TELL
"Ok, but there was plenty enough there alresey." GR?)
		      (T
		       <TELL
