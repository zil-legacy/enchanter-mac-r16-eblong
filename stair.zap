...
?ELS5:	EQUAL?	HERE,ENDLESS-STAIR \FALSE
	...
	PRINTI	"The stairway begins to dissolve before your eyes, leaving a circular area with exits east and west, but remarkable mainly for its absence of a floor. Indeed, you find yourself standing in mid-air above a deep pit with the sort of comical look which is found mainly among duped cartoon characters. Frantically, you grab for the solid bannister"
...
""I am through playing games, carnival-clown! You shall return to your Circle, but I am afraid that all the little pieces will prove hard to re-assemble!"" He laughs hideously and starts a guttural chant which shakes the very tower."
	CRLF	
	SET	'KRILL-KILL,1
	CALL	QUEUE,I-BYE,2
	PUT	STACK,0,1
