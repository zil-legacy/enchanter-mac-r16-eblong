...
?ELS60:	CALL	WT?,WRD,PS?DIRECTION,P1?DIRECTION >VAL
	ZERO?	VAL /?ELS75
	EQUAL?	VERB,0,ACT?WALK,ACT?FLY \?ELS75
	EQUAL?	LEN,1 /?THN78
	EQUAL?	LEN,2 \?ELS81
...
?REP41:	ZERO?	DIR /?CND143
	...
	SET	'TRY-FLY,1
	JUMP	?CND147
?ELS149:	SET	'TRY-FLY,0
?CND147:	SET	'PRSO,DIR
	SET	'P-WALK-DIR,DIR
	RTRUE	
?CND143:	SET	'P-WALK-DIR,0
	ZERO?	P-OFLAG /?CND152
	CALL	ORPHAN-MERGE
...
?ELS67:	ZERO?	LEN \?CND70
	SET	'LEN,OLEN
?CND70:	EQUAL?	WINNER,PROTAGONIST /?ELS75
	CALL	CANT-ORPHAN
	RFALSE	
