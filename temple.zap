...
?ELS37:	EQUAL?	PRSA,V?NITFOL \FALSE
	...
	PRINTR	"The door is locked outside. Even if you could open it, the guards would undoubtably return you with little difficulty."
?ELS5:	EQUAL?	PRSA,V?KNOCK \?ELS11
	PRINTR	"It would only get the attention of the guards."
?ELS11:	EQUAL?	PRSA,V?REZROV \FALSE
...
?ELS20:	EQUAL?	PRSA,V?SEARCH \FALSE
	...
	CALL	BLT,WINNER,TOWER-S >ANYTHING-TAKEN
